...
- Wie der Workflow mit meinen Komponenten funktioniert ?
  ...
  In der Klasse Abgabe wird die Abgabefrist überprüft und nur falls sie gültig ist, Kann der Student neue Abgabe erzeugn
  und in die Datenbank schreiben und seine Dateien hochladen.

  Die Korrektoren können auf die Abgaben ihrer zugewiesenen Studierende zugreifen und dazu Kommentare schreiben und
  Das Ergebniss jeder Abgabe bestimmen.
  ( Beispiel:
   durch die Methoden
